...
using Convesys.Common.MessageHandling.Tests.L0.TestMocks;
...
namespace Convesys.Common.MessageHandling.Tests.L0.Factories
{
    [TestFixture]
    [Category("Convesys.Common.MessageHandling.Tests.L0")]
    public class HandlerResolverTests
    {
        ...
        public class ResolveAllHandlersForMethod : HandlerResolverTests
        {
            ...
            {
                //ARRANGE
                var logger = new Mock<IEventLogger<BaseMessageHandler<TestMessage>>>();
            ...
            public void Handler_Can_Be_Resolved_When_Not_Registered_Without_Any_Assembly_Filtering()
            {
                ...
                object action;
                object boolean;
                object logger = new Mock<IEventLogger<BaseMessageHandler<TestMessage>>>().Object;
                ...
                _mockDependenyResolver.Setup(x => x.TryResolve(typeof(bool), out boolean))
                    .Returns(true);
                _mockDependenyResolver.Setup(x => x.TryResolve(typeof(IEventLogger<BaseMessageHandler<TestMessage>>), out logger))
                    .Returns(true);
                var handlerResolver =
                    new HandlerResolver(_mockDependenyResolver.Object, _mockHandlerResolverSettings.Object);
