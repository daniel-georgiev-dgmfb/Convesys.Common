...
using Convesys.Common.Serialisation.Binary.Tests.L0.TestSerialisableObjects;
using NUnit.Framework;

namespace Convesys.Common.Serialisation.Binary.Tests.L0
{
    [TestFixture]
    [Category("Convesys.Common.Serialisation.Binary.Tests.L0")]
