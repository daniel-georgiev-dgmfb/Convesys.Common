...
using Convesys.Common.Serialisation.JSON.Tests.L0.SerialisableObjects;
using Convesys.Common.Serialisation.JSON.SettingsProviders;
using Convesys.Kernel.Serialisation;
using Newtonsoft.Json.Linq;
using NUnit.Framework;

namespace Convesys.Common.Serialisation.JSON.Tests.L0
{
    [TestFixture]
    [Category("Convesys.Common.Serialisation.JSON.Tests.L0")]
