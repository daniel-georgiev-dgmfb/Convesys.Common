...
using Convesys.Common.Compression.Deflation;
using NUnit.Framework;

namespace Convesys.Common.Compression.Deflate.Tests.L0
{
    [TestFixture]
    [Category("Convesys.Common.Compression.Deflate.Tests.L0")]
    public class DelationCompressorTests
    {
        ...
        private Stream GetTextStream()
        {
            return Assembly.GetExecutingAssembly()
                .GetManifestResourceStream("Convesys.Common.Compression.Deflate.Tests.L0.Lorem ipsum.txt");
        }
    }
}
